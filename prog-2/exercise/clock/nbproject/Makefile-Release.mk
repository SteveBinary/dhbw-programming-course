...
${OBJECTDIR}/TestUtils.o: TestUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestUtils.o TestUtils.cpp
...
${TESTDIR}/tests/CAlarmClockTest.o: tests/CAlarmClockTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CAlarmClockTest.o tests/CAlarmClockTest.cpp


${TESTDIR}/tests/CCounterTest.o: tests/CCounterTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CCounterTest.o tests/CCounterTest.cpp


${TESTDIR}/tests/CGMTClockTest.o: tests/CGMTClockTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CGMTClockTest.o tests/CGMTClockTest.cpp


${TESTDIR}/tests/CStopWatchTest.o: tests/CStopWatchTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CStopWatchTest.o tests/CStopWatchTest.cpp


${TESTDIR}/tests/CTimeTest.o: tests/CTimeTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CTimeTest.o tests/CTimeTest.cpp


${TESTDIR}/tests/CWorldTimeClockTest.o: tests/CWorldTimeClockTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CWorldTimeClockTest.o tests/CWorldTimeClockTest.cpp
...
${OBJECTDIR}/TestUtils_nomain.o: ${OBJECTDIR}/TestUtils.o TestUtils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestUtils_nomain.o TestUtils.cpp;\
	else  \
