...
${OBJECTDIR}/DatasetGenarator.o: DatasetGenarator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DatasetGenarator.o DatasetGenarator.cpp

${OBJECTDIR}/Name.o: Name.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Name.o Name.cpp

${OBJECTDIR}/Person.o: Person.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Person.o Person.cpp
...
${TESTDIR}/tests/AlgorithmTest.o: tests/AlgorithmTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/AlgorithmTest.o tests/AlgorithmTest.cpp


${TESTDIR}/tests/ArrayTest.o: tests/ArrayTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ArrayTest.o tests/ArrayTest.cpp


${TESTDIR}/tests/CircularBufferTest.o: tests/CircularBufferTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CircularBufferTest.o tests/CircularBufferTest.cpp


${TESTDIR}/tests/DatasetGeneratorTest.o: tests/DatasetGeneratorTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DatasetGeneratorTest.o tests/DatasetGeneratorTest.cpp


${TESTDIR}/tests/NameTest.o: tests/NameTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/NameTest.o tests/NameTest.cpp


${TESTDIR}/tests/PersonTest.o: tests/PersonTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PersonTest.o tests/PersonTest.cpp


${TESTDIR}/tests/SerializerTest.o: tests/SerializerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SerializerTest.o tests/SerializerTest.cpp


${TESTDIR}/tests/UtilTest.o: tests/UtilTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UtilTest.o tests/UtilTest.cpp
...
${OBJECTDIR}/DatasetGenarator_nomain.o: ${OBJECTDIR}/DatasetGenarator.o DatasetGenarator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DatasetGenarator_nomain.o DatasetGenarator.cpp;\
	else  \
...
${OBJECTDIR}/Name_nomain.o: ${OBJECTDIR}/Name.o Name.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Name_nomain.o Name.cpp;\
	else  \
...
${OBJECTDIR}/Person_nomain.o: ${OBJECTDIR}/Person.o Person.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Person_nomain.o Person.cpp;\
	else  \
